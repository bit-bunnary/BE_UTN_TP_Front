                ...
                <form className="workspace-form" onSubmit={onSubmitForm}>
                    ...
                    <div className="form-group">
                        ...
                        <textarea
                            ...
                            disabled={isLoading}
                        />
                        <div className={`char-counter ${form_state.description.length > 190 ? 'limit-near' : ''} ${form_state.description.length >= 200 ? 'limit-reached' : ''}`}>
                            {form_state.description.length} / 200
                        </div>
